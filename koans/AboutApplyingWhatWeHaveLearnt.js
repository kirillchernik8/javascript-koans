...
describe("About Applying What We Have Learnt", function() {
  ...
  it("should add all the natural numbers below 1000 that are multiples of 3 or 5 (functional)", function () {
    var sum = _.reduce(_.filter(_.range(1,1001), function(element){return element%3===0||element%5===0}), function(el, em) {return el+em})
  ...
  it("should count the ingredient occurrence (functional)", function () {
    ...
    _(products).chain().map(function(name){
    	...
    	}).flatten().reduce(function(number, val){
    		return ingredientCount[val] = (ingredientCount[val] || 0) + 1;
    	},0);
